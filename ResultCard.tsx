  ...
  return (
    <div className="w-full max-w-6xl mx-auto animate-fade-in-up">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <div className="md:col-span-4 bg-white rounded-3xl p-6 border border-slate-200 shadow-sm border-l-4 border-l-rose-400">
        ...
        <div className="md:col-span-4 bg-white rounded-3xl p-6 border border-slate-200 shadow-sm border-l-4 border-l-indigo-400">
        ...
        <div className="md:col-span-4 bg-white rounded-3xl p-6 border border-slate-200 shadow-sm border-l-4 border-l-orange-400">
        ...
        <div className="md:col-span-6 bg-white rounded-3xl p-6 border border-slate-200 shadow-sm border-l-4 border-l-teal-400">
